...
import (
	...
	cachefs "github.com/fastschema/fastschema/pkg/cache"
...
func (a *App) getDefaultCache() (err error) {
	...
	if utils.Env("CACHE_DRIVERS") != "" && cacheDriversConfig == nil {
		if err := json.Unmarshal([]byte(utils.Env("CACHE_DRIVERS")), &cacheDriversConfig); err != nil {
			return err
		}
	}
	...
	if a.caches, err = cachefs.NewFromConfig(cacheDriversConfig); err != nil {
		return err
	}
