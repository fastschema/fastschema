...
func TestMockLoggerWithContext(t *testing.T) {
	...
	l = app.CreateMockLogger()
	context = app.LogContext{"extra": "debug"}
...
func TestMockLoggerMessages(t *testing.T) {
	l := app.CreateMockLogger()
	assert.Equal(t, app.MockLoggerMessage{}, l.Last())
